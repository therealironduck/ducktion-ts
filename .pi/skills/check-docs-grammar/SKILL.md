...
Check and fix grammar and spelling in documentation markdown files. You (pi) do the checking — no external tool is involved. The driver script at `.pi/skills/check-docs-grammar/driver.mjs` handles file discovery; you read each file and apply corrections with the edit tool.
...
node .pi/skills/check-docs-grammar/driver.mjs

# Specific file
node .pi/skills/check-docs-grammar/driver.mjs docs/getting-started.md

# Whole directory
node .pi/skills/check-docs-grammar/driver.mjs docs/
```
